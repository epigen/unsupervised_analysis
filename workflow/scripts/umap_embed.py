...
data_path = snakemake.input[
    0  # "/nobackup/lab_bock/projects/macroIC/results/AKsmall/KOcall_NonTargeting/counts/CORRECTED_RNA.csv"
]
graph_object_path = snakemake.input[
    1  # snakemake.input["knn_object"] #"/nobackup/lab_bock/projects/macroIC/results/AKsmall/unsupervised_analysis/AKsmall_KOcall_NonTargeting_CORRECTED/UMAP_correlation_100_graph.pickle"
]
# outputs
result_object_path = snakemake.output[
    "result_object"  # "/nobackup/lab_bock/projects/macroIC/results/AKsmall/unsupervised_analysis/AKsmall_KOcall_NonTargeting_CORRECTED/UMAP_correlation_100_0.1_2_object.pickle"
]
result_data_path = snakemake.output[
    "result_data"  # "/nobackup/lab_bock/projects/macroIC/results/AKsmall/unsupervised_analysis/AKsmall_KOcall_NonTargeting_CORRECTED/UMAP_correlation_100_0.1_2_data.csv"
]
result_axes_path = snakemake.output[
    "result_axes"  # "/nobackup/lab_bock/projects/macroIC/results/AKsmall/unsupervised_analysis/AKsmall_KOcall_NonTargeting_CORRECTED/UMAP_correlation_100_0.1_2_axes.csv"
]
